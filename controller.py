...
class Controller(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc2 = nn.Linear(10, 8) # changed it from 10, 8 to 10,12 its what isaac-ant expects
        #also testing to see (48,64)
        #                    (64.12)
    ...
    def mutate(self, mutation_strength=0.25):#was 0.05 changed to 0.15, further increased to 0.5 to see clear differences
        #0.5 - > 0.7
        #set to 0.25 for more stability on inheritence
